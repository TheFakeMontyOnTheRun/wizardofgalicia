...
JNIEXPORT void JNICALL
        Java_br_odb_wog_GL2JNILib_setTexture(JNIEnv *env, jclass type, jobjectArray bitmap,jcharArray chars_);
...
JNIEXPORT void JNICALL
Java_br_odb_wog_GL2JNILib_setTexture(JNIEnv *env, jclass type, jobjectArray bitmaps, jcharArray representation ) {
